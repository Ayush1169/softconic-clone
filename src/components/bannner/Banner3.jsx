...
function Banner3() {
    ...
    return (
        <div className="banner-area3">
                ...
                <SwiperSlide>
                    <div className="banner-wrapper">
                        ...
                        <div className="banner-image magnetic-item">
                            <img className="img-fluid" src="assets/img/homePage/heroSection.png" alt="" />
                        </div>
                        <div className="banner-video-area">
                            <div className="video-area">
                                <div data-fancybox="gallery" className="video-popup"
                                ...
                                <img className="video-img" src="assets/img/homePage/heroSection2.png" alt="" />
                            </div>
                        </div>
                    </div>
                </SwiperSlide>
            ...
            <div className="swiper-pagination-banner3" />
            <React.Fragment>
